...
var options = {
  ...
  getPageURI: function(index, reduce, rotate) {
      ...
      var url = '/static/BookReader/images/'+leafStr.replace(re, imgStr) + '.jpg';
      return url;
  },
  ...
  metadata: [
    {label: 'Title', value: 'The Pavoni Family Cookbook'},
    {label: 'Author', value: 'Emily and Charles'},
    {label: 'Info', value: 'This cookbook was a gift for Mandy and Mario on their wedding day.'},
  ],
  // This toggles the mobile drawer (not shown in 'embed' mode)
  enableMobileNav: false,
  mobileNavTitle: "Mandy's Cookbook",
...
// Start in FullScreen/2pg Mode ALWAYS!
br.enterFullscreen();
br.switchMode(2);

// FullScreen toggle disabled in CSS